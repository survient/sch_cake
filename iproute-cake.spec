%global commit 39687310e5fc0c45e944d3045b138abc861d364c
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global snapshotdate 20180521
%global debug_package %{nil}
%global cbq_version v0.7.3
Summary:            Advanced IP routing and network device configuration tools with cake
Name:               iproute-cake
Version:            4.16.0
Release:            1%{?dist}
Group:              Applications/System
URL:                https://github.com/dtaht/tc-adv.git
Source0:            https://github.com/dtaht/tc-adv/archive/%{commit}/%{name}-%{version}-%{shortcommit}.tar.gz
...
Provides:           iproute%{?_isa} = %{version}-%{release}
Conflicts:          iproute < %{version}-%{release}
Recommends:         %{name}-tc
...
%package tc
Summary:            Linux Traffic Control utility with cake
Group:              Applications/System
License:            GPLv2+
Obsoletes:          iproute < %{version}-%{release}
Provides:           iproute-tc = %{version}-%{release}
Provides:           iproute-tc%{?_isa} = %{version}-%{release}
Conflicts:          iproute-tc < %{version}-%{release}
...
%if ! 0%{?_module_build}
%package doc
Summary:            Documentation for iproute2 utilities with examples and cake
Group:              Applications/System
License:            GPLv2+
Provides:           iproute-doc = %{version}-%{release}
Provides:           iproute-doc%{?_isa} = %{version}-%{release}
Conflicts:          iproute-doc < %{version}-%{release}
...
%package devel
Summary:            iproute development files and cake
Group:              Development/Libraries
License:            GPLv2+
Provides:           iproute-static = %{version}-%{release}
Provides:           iproute-devel = %{version}-%{release}
Provides:           iproute-devel%{?_isa} = %{version}-%{release}
Conflicts:          iproute-devel < %{version}-%{release}
